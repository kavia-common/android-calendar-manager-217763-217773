...
/**
 * PUBLIC_INTERFACE
 * Basic controller providing welcome, docs redirect, health, and info endpoints.
 */
@RestController
...
public class HelloController {
    ...
    /**
     * PUBLIC_INTERFACE
     * API docs convenience endpoint that redirects to Swagger UI, preserving original scheme/host/port.
